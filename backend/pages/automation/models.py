...
class Error(models.Model):
    ...
    Description: str = models.CharField(max_length=120, null=True, blank=True)
...
class Specification(models.Model):
    ...
    Outputs: List[Input] = models.ManyToManyField(
...
def delete_all_many_to_many(sender, instance: Microbot, using, **kwargs):
    try:
